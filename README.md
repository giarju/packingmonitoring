# things to change back for config
* vueconfig to change proxy to server back to mock (remove proxy and change (after) -> (before) for mock js)
* change permission.js (delete all testing)
